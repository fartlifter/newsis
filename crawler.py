...
keyword_groups = {
    '시경': ['서울경찰청'],
    '본청': ['경찰청'],
    '종로중부': ['종로', '종암', '성북', '고려대', '참여연대', '경실련', '중부', '중구', 
        '남대문', '용산', '국가인권위원회', '동국대', '숙명여대', '순천향대병원'],
    '혜화도봉': ['혜화', '동대문', '중랑', '성균관대', '한국외대', '서울시립대', '경희대', '서울대병원',
        '노원', '강북', '도봉', '북부지법', '북부지검', '상계백병원',],
    '마포': ['마포', '서대문', '서부', '은평', '서부지검', '서부지법', '연세대', '반부패범죄수사대', '공공범죄수사대',
        '금융범죄수사대', '마약범죄수사대', '신촌세브란스병원', '군인권센터'],
